...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE usuarios (ID INTEGER PRIMARY  KEY AUTOINCREMENT, username TEXT, password TEXT, nombre TEXT, apellidos TEXT, fecha_nac TEXT, nivel INTEGER)");
    }
    ...
    public long addUser(String user, String password, String nombre, String apellidos, String fecha){
